...
export function SessionListUser({ onChatSelect, selectedSessionId }: SessionListProps) {
  ...
  const getSessionLanguages = (session: IClientSession) => {
                  ...
                  >
                    ...
                    <Box sx={{ flexShrink: 0, pt: 0.5 }} className='msgFgOutr'>
                      {
                        ...
                        >
                          <Image
                            src={
                              session.interpreter_details?.profile_image
                                ? mediaUrl(
                                    `interpreter_profile_pic/${session.interpreter_details.profile_image}`
                                  )
                                : assest.dashboardHeaderAvatarImage
                            }
                            width={48}
                            height={48}
                            alt={`client-${session.interpreter_details?._id}`}
                    ...
                    >
                      ...
                      <Typography
                        ...
                        title={session.interpreter_details?.full_name}
                        className='msgNms'
                      >
                        {session.interpreter_details?.full_name || 'NA'}
                      </Typography>
