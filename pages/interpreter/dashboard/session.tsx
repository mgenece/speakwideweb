...
function Session() {
  ...
  if (credentials.apiKey && credentials.sessionId && credentials.token && interpreterData?._id) {
    return (
      <VonageVideoSession
        credentials={credentials}
        displayName={interpreterData?.full_name || 'Interpreter'}
  ...
  // Hand off to VonageVideoSession; it handles pre-join DevicePreview internally
}
